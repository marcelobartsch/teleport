...
func (c *Client) dialGRPC(ctx context.Context, addr string) error {
	...
	dialOpts = append(dialOpts,
		grpc.WithChainUnaryInterceptor(metadata.UnaryClientInterceptor, breaker.UnaryClientInterceptor(cb)),
		grpc.WithChainStreamInterceptor(metadata.StreamClientInterceptor, breaker.StreamClientInterceptor(cb)),
	)
